...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-gradient-to-br from-blue-50 via-white to-purple-50 px-4 py-8">
      <ToastContainer
        position="top-right"
        autoClose={3000}
        hideProgressBar={false}
      ...
      <div className="w-full max-w-md">
        ...
        {/* Login Form */}
        <form onSubmit={handleSubmit} className="bg-white/80 backdrop-blur-sm p-6 sm:p-8 shadow-xl rounded-2xl border border-white/20">
          {/* Error Message */}
          {error && (
        ...
        {/* Sign Up Link */}
        <div className="text-center mt-6 p-4 bg-white/60 backdrop-blur-sm rounded-xl border border-white/20">
        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-gradient-to-br from-blue-50 via-white to-purple-50 text-gray-500">Or continue with</span>
            </div>
          </div>
