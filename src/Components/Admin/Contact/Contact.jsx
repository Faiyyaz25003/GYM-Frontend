      ...
      <div className="relative bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 text-white py-20">
        ...
        <div className="relative max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            We're here to help you on your fitness journey. Connect with us anytime.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Send Message</h2>
            ...
            <div className="space-y-6">
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 resize-none"
                ></textarea>
              </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Connect with us for membership details, training programs, and more.
              </p>
            </div>

            <div className="grid gap-6">
              {contactInfo.map((item, index) => (
                <div key={index} className="flex items-start space-x-4 p-6 bg-gray-50 rounded-xl hover:bg-gray-100 transition">
            ...
            <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-xl p-6 text-white">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-white/20 p-3 rounded-full hover:bg-white/30"><Instagram className="w-6 h-6" /></a>
                <a href="#" className="bg-white/20 p-3 rounded-full hover:bg-white/30"><Facebook className="w-6 h-6" /></a>
                <a href="#" className="bg-white/20 p-3 rounded-full hover:bg-white/30"><Twitter className="w-6 h-6" /></a>
              </div>
            </div>
