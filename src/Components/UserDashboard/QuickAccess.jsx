  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      ...
      <div
        ...
        className="cursor-pointer bg-blue-100 border border-blue-300 rounded-xl shadow p-6 flex items-center gap-4 hover:bg-blue-200 transition"
      >
      ...
      {showDiet && (
        <div className="fixed inset-0 flex items-center justify-center backdrop-blur-sm bg-white/30 z-50">
          <div className="bg-white rounded-lg shadow-lg w-full max-w-4xl p-6 relative border">
            ...
            <Diet/> {/* Display API diet data here */}
          </div>
        </div>
      )}
    </div>
